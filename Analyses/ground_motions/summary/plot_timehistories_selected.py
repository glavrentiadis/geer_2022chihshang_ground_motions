...
#components
cmp_names = ['FN','FP'] if flag_rot else ['N','E']

#ground motion data
dir_gm = '../../../Data/ground_motions/corrected_gm' + ('_rot/' if flag_rot else '/')  + 'M6.9_0918/'
fn_sta = ['TTN061', 'HWA054', 'TTN014']
n_sta  = ['TSMIP - TTN061', 'TSMIP - HWA054', 'TSMIP - TTN014']
